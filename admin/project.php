  ...
  <div class="container">
    ...
    <table class="table table-hover text-center">
      ...
      <tbody>
        <?php
        $no = 1;
        $sql = "SELECT p.*, d.name AS department_name FROM Project p INNER JOIN Department d ON p.DepartmentID = d.ID";
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                       <a href="delete_project.php?id=<?php echo $row["ID"] ?>" class="btn btn-success">Confirm</i></a>
                    </div>
                  </div>
                </div>
              </div>
