        ...
        if (isset($_POST["submit"])) {
            ...
            if(isset($_FILES['image'])){
                ...
                if($image_error === 0){
                    ...
                    if(in_array($image_ext, $allowed)){
                        ...
                        if($image_size <= 2000000){
                            ...
                            if(move_uploaded_file($image_tmp, $destination)){
                                ...
                                $insert_query = "UPDATE `users` SET `first_name`='$first_name', `last_name`='$last_name', `email`='$email', `NID`='$NID', `desig_id`='$desig_id', `image`='$new_image_name',`dob`='$dob',`gender`='$gender' WHERE id = $id";
                    ...
                    // Redirect with error message
                    $insert_query = "UPDATE `users` SET `first_name`='$first_name', `last_name`='$last_name', `email`='$email', `NID`='$NID', `desig_id`='$desig_id', `dob`='$dob',`gender`='$gender' WHERE id = $id";
                    $insert_query_result = mysqli_query($conn, $insert_query);
                    // Check if insertion was successful
                    if($insert_query_result){
                        // Redirect with success message
            ...
            <form action="" method="post" class="mb-3" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
                ...
                <?php } ?>
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="first_name" style="margin-bottom: 20px;" value="<?php echo $row['first_name'] ?>">
                    </div>
                    <div class="col">
                        <label class="form-label">Enter Last Name</label>
                        <input type="text" class="form-control" name="last_name" style="margin-bottom: 20px;" value="<?php echo $row['last_name'] ?>">
                    </div>
                    <div class="col1">
