  ...
  <div class="container">
    ...
    <table class="table table-hover text-center">
      ...
      <tbody>
        <?php
        $no = 1;
        $sql = "SELECT l.*, u.first_name, u.last_name FROM leaves l INNER JOIN users u ON l.user_id = u.id";
            ...
            <td>
                <?php 
                  if(isset($row["attachment"])){
                    ...
                    <a href="uploads/documents/<?php echo $row["attachment"] ?>" target="_blank" class="link-primary"><i class="fas fa-download"></i></a>
                    <?php
                  }else{
                    ?>No Attachment<?php
                  }
